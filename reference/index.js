 ...
 *
 * 2. *Transformation* takes this abstract representation and manipulates(操纵) to do
 ...
 * -------
 *
 * Parsing typically gets broken down into two phases: Lexical(词汇的) Analysis and
 * Syntactic(语法的) Analysis.
 *
 * 1. *Lexical Analysis* takes the raw code and splits it apart into these things
 *    called tokens(符号) by a thing called a tokenizer (or lexer).
 *
 *    Tokens are an array of tiny little objects that describe an isolated(单独的) piece
 *    of the syntax. They could be numbers, labels, punctuation(标点符号), operators,
 *    whatever.
 *
